...
export class SocialsManager {
    ...
    async follow(parameters: {
        ...
        // References
        const userCollectionRef = DatabaseAssistant.shared.collection(DatabaseCollections.users);
        ...
        const followersCollectionRef = followingUserDocumentRef.collection(DatabaseCollections.followers);
        const followingsCollectionRef = followerUserDocumentRef.collection(DatabaseCollections.followings);
    ...
    async followers(parameters: {
        ...
        const followersCollectionRef = userDocumentRef.collection(DatabaseCollections.followers);
    ...
    async followings(parameters: {
        ...
        const usersCollectionRef = DatabaseAssistant.shared.collection(DatabaseCollections.users);
        const userDocumentRef = usersCollectionRef.doc(parameters.userId.valueOf());
        const followersCollectionRef = userDocumentRef.collection(DatabaseCollections.followings);
    ...
    async isFollowing(parameters: {
        ...
        const followingsCollectionRef = followerDocumentRef.collection(DatabaseCollections.followings);
    ...
    async isFollower(parameters: {
        ...
        const followersCollectionRef = followingDocumentRef.collection(DatabaseCollections.followers);
